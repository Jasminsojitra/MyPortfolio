...
List<Project> PROJECTS = [
  ...
  Project(
    ...
    url: 'https://play.google.com/store/apps/details?id=com.natrix.project',
  ...
  Project(
    name: 'CoronaReminder',
    description:
    'App allows users to create/set reminders in a users mobile phone without any internet or WiFi connection. Users can add Title, Description, Date & Time for reminder, Type of reminder and period to remind and save the reminder.',
    image: 'assets/images/projects/coronareminder.jpeg',
    url: 'https://drive.google.com/drive/folders/1nA3KKDtEh4zB9XUKlPz7QKj_ITvfycCT?usp=sharing',
    iOSUrl: 'https://drive.google.com/drive/folders/1S-Jni0JTv6DE9J-cUXb9gyP9bJjsrTS3?usp=sharing',
    skills: [
      'Flutter',
      'Sqlite',
    ],
  ...
  Project(
    name: 'Natapp',
    description:
    'App allows user to authenticate using firebase gmail authentication.Users can do one to one video call, audio call and chat with another user.',
    image: 'assets/images/projects/NatApp.jpeg',
    url: 'https://drive.google.com/drive/folders/1Jtie9wdzYYu3wdTCkD6Q0sNgZB5jSq5b?usp=sharing',
    iOSUrl: 'https://drive.google.com/drive/folders/1N6MGKC2zW8IV_63LZdu1fNfCMYaF97IK?usp=sharing',
    skills: [
      'Flutter',
      'Firebase',
      'Google AdMob',
